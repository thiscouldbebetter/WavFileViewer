...
(function (ThisCouldBeBetter) {
    ...
    (function (WavFileViewer) {
        class WavFile //
         {
            ...
            // Drawing.
            toCanvasOfSizeInPixels(sizeInPixels) {
                var d = document;
                ...
                var samplePosInPixels = WavFileViewer.Coords.fromXY(0, 0);
        ...
        WavFileViewer.WavFileSamplingInfo = WavFileSamplingInfo;
